...
namespace BloodDonorApp.Converters
{
    class MedicalFormConvert : IMultiValueConverter
    {
        ...
        public object[] ConvertBack(object value, Type[] targetTypes, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            object[] result = new object[9] { pers.DonorCnp, pers.Name, pers.Domiciliu, pers.Resedinta, pers.Email, pers.PhoneNr, pers.FormId, pers.PatientName, pers.Grupa };
            return result;
        }
    }
}
